...
public class CasePresentationForTheoryRubrics extends AppCompatActivity implements View.OnClickListener {
    ImageButton unhappy,neutral,happy,vhappy;
    Bundle bundle;
    String username;
    Spinner[] inputs = new Spinner[8];
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_case_presentation_for_theory_rubrics);
        init();
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.log_out)
        {
            startActivity(new Intent(CasePresentationForTheoryRubrics.this,MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            finish();
        }
    ...
    public void init(){
        ...
        inputs[0]=findViewById(R.id.cptr1);
        inputs[1]=findViewById(R.id.cptr2);
        inputs[2]=findViewById(R.id.cptr3);
        inputs[3]=findViewById(R.id.cptr4);
        inputs[4]=findViewById(R.id.cptr5);
        inputs[5]=findViewById(R.id.cptr6);
        inputs[6]=findViewById(R.id.cptr7);
        inputs[7]=findViewById(R.id.cptr8);
        unhappy=findViewById(R.id.cptrunhappy);
        neutral=findViewById(R.id.cptrneutral);
        happy=findViewById(R.id.cptrhappy);
        vhappy=findViewById(R.id.cptrvhappy);
        ...
        ImageButton imageButton=findViewById(R.id.cptrimg);
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CasePresentationForTheoryRubrics.this,Pop1.class));
            }
        });
        addItemsOnSpinner();


        button=findViewById(R.id.cptr_submit);
    ...
    public void onClick(View v) {
        ...
        ParseQuery<ParseObject> query = ParseQuery.getQuery("CasePresentationTheoryRubrics");
        ...
        builder.setMessage("Once submitted cannot be revised. Do you want to Continue ?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ParseObject registerObject = new ParseObject("CasePresentationTheoryRubrics");
                        registerObject.put("username", username);
                        JSONArray array = new JSONArray(list);
                        EditText editText=findViewById(R.id.commentcptr);
